...
public class LoginTest extends BaseTest {
    ...
    @Test
    public void capsIncorrectLogin() {
        loginPage.open();
        loginPage.login("Standard_user", "secret_sauce");

        assertTrue(loginPage.isErrorDisplayed(), "Нет сообщения об ошибке");
        assertEquals(loginPage.getErrorText(), "Epic sadface: Username and password do not match " +
                "any user in this service", "Неверный текст сообщения об ошибке");
    }
}
